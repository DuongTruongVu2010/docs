    ...
    <div className='flex-1 flex items-center justify-center'>
        ...
        >
            ...
            <Button
                ...
                variant='ghost'
                size="icon"
                className='absolute left-3 top-1/2 -translate-y-1/2 [&_svg]:size-5 rounded-l-full'
            >
                <SearchIcon />
            </Button>
            {value && (
                <Button
                    ...
                    variant='ghost'
                    size="icon"
                    className='absolute right-3 top-1/2 -translate-y-1/2 [&_svg]:size-5 rounded-r-full'
                >
                    <XIcon />
                </Button>
            )
