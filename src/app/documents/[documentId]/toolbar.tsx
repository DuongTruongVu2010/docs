    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                    className="h-7 min-w-7 shrink flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
...
const FontSizeButton = () => {
    ...
    return (
        <div className="flex items-center gap-x-0.5">
            <button
                onClick={decrement}
                className="h-7 w-7 shrink flex items-center justify-center rounded-sm hover:bg-neutral-200/80" 
            >
...
const LitsButton = () => {
    ...
    const lists = [
        ...
        },
        {
            ...
            isActive: () => editor?.isActive("oederedList"),
...
const HeadingLevelButton = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
            <button
                    className="h-7 min-w-7 shrink flex items-center justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
                >
...
const FontFamilyButton = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild >
                <button
                    className="h-7 w-[120px] shrink flex items-center justify-between rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
                >
                    <span className="truncate">
...
const ToolbarButton = ({ 
    ...
    return (
        <button
            onClick={onClick}
            className={cn(
                "text-sm h-7 flex min-w-7 items-center justify-center rounded-sm hover:bg-neutral-200/80", 
                isActive && "bg-neutral-200/80"
            )}
        >
            <Icon className="size-4"/>
...
const Toolbar = () => {
    const { editor } = useEditorStore()
    console.log("toolbar editer: ", { editor })
    const sections: {
        label: string; 
        icon: LucideIcon, 
        onClick: () => void
